...
- Before dispatch, say the delivery estimate starts once it leaves our hub.`,
  ...
  documents: {
    tools: [
      ...
      "- They want to upload, retake or replace a document in the chat: you can't, and never offer to. Signed in: call get_document_status and tell them to do it on their Profile, with its button. A guest: call get_my_kyc_status. Not signed in and on the signup screen: they upload it on signup's own documents step.",
    ],
  },
  booking: {
    tools: [
