...
import OpsCases from '@/pages/ops/OpsCases';
import OpsCaseDetail from '@/pages/ops/OpsCaseDetail';
...
export function OpsRoutes() {
  return (
    <Switch>
      ...
      <Route path="/ops/cases" component={OpsCases} />
      <Route path="/ops/cases/:id" component={OpsCaseDetail} />
