...
If the screen then says **Application sent**, the Bombino team sets the account up for you. Until it's ready you're a guest on the same number and can book as usual; **My Profile** shows where it stands. If the team asks for a change, the note and what to change are there, and **Make the change** opens **Update your application**, which asks only for what they ticked: the details to correct and the documents to upload again. Everything else stays as you sent it; tap **Send changes to Bombino** when done. When it's ready you get an email with your login details, and you sign in again with your mobile number. You can **Withdraw application** from **My Profile** while it's open.
