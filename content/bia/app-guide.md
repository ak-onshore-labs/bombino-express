...
## Opening an account
Asked as: sign up, signup, register, create account, open account, new account, company account, business account, personal account, which account, corporate, co-courier, e-commerce, ecommerce, FBB, contract

You can book without an account, as a guest. To open one: open the menu (☰), tap **Sign In** and verify your mobile number with the code; a number that has no account yet goes straight on to signup. Choose the account type (Personal for yourself; for a business: Corporate, Co-Courier, E-commerce or FBB), fill in your details, enter your identity numbers and upload the document that carries each, then review your details and sign the contract to open the account. Not sure which type? Ask me what you ship and I'll suggest one. Anything you booked as a guest with the same number moves into the account.
